...
/* Refer to https://github.com/componentjs/myrequire/blob/master/lib/myrequire.js */
/**
...
function myrequire(path, parent, orig) {
  var resolved = myrequire.resolve(path);

  // lookup failed
  if (null == resolved) {
    orig = orig || path;
    parent = parent || 'root';
    var err = new Error('Failed to myrequire "' + orig + '" from "' + parent + '"');
    err.path = orig;
    err.parent = parent;
    err.myrequire = true;
    throw err;
  ...
  var module = myrequire.modules[resolved];

  // perform real myrequire()
  // by invoking the module's
  // registered function
  if (!module.exports) {
    module.exports = {};
    module.client = module.component = true;
    module.call(this, module.exports, myrequire.relative(resolved), module);
  }
...
myrequire.resolve = function(path) {
  ...
  for (var i = 0; i < paths.length; i++) {
    var path = paths[i];
    if (has.call(myrequire.modules, path)) return path;
  }

  if (has.call(myrequire.aliases, index)) {
    return myrequire.aliases[index];
  }
};
...
myrequire.normalize = function(curr, path) {
  var segs = [];
...
myrequire.register = function(path, definition) {
  myrequire.modules[path] = definition;
};
...
myrequire.alias = function(from, to) {
  if (!has.call(myrequire.modules, from)) {
    throw new Error('Failed to alias "' + from + '", it does not exist');
  }
  myrequire.aliases[to] = from;
};

/**
 * Return a myrequire function relative to the `parent` path.
 *
 * @param {String} parent
 * @return {Function}
 * @api private
...
myrequire.relative = function(parent) {
  var p = myrequire.normalize(parent, '..');
  ...
  /**
   * The relative myrequire() itself.
   */

  function localRequire(path) {
    var resolved = localRequire.resolve(path);
    return myrequire(resolved, parent, path);
  }
  ...
  localRequire.resolve = function(path) {
    ...
    if ('.' == c) return myrequire.normalize(p, path);
  ...
  localRequire.exists = function(path) {
    return has.call(myrequire.modules, localRequire.resolve(path));
  };

  return localRequire;
};
myrequire.register("component-indexof/index.js", function(exports, myrequire, module){
...
myrequire.register("component-emitter/index.js", function(exports, myrequire, module){

/**
 * Module dependencies.
 */

var index = myrequire('indexof');
...
myrequire.register("NetEase-pomelo-protocol/lib/protocol.js", function(exports, myrequire, module){
...
})('object' === typeof module ? module.exports : ({}),'object' === typeof module ? Buffer : Uint8Array, this);

});
myrequire.register("pomelonode-pomelo-protobuf/lib/client/protobuf.js", function(exports, myrequire, module){
...
myrequire.register("pomelonode-pomelo-jsclient-websocket/lib/pomelo-client.js", function(exports, myrequire, module){
(function() {
...
myrequire.register("boot/index.js", function(exports, myrequire, module){
  var Emitter = myrequire('emitter');
...
myrequire.alias("boot/index.js", "pomelo-client/deps/boot/index.js");
myrequire.alias("component-emitter/index.js", "boot/deps/emitter/index.js");
myrequire.alias("component-indexof/index.js", "component-emitter/deps/indexof/index.js");

myrequire.alias("NetEase-pomelo-protocol/lib/protocol.js", "boot/deps/pomelo-protocol/lib/protocol.js");
myrequire.alias("NetEase-pomelo-protocol/lib/protocol.js", "boot/deps/pomelo-protocol/index.js");
myrequire.alias("NetEase-pomelo-protocol/lib/protocol.js", "NetEase-pomelo-protocol/index.js");

myrequire.alias("pomelonode-pomelo-protobuf/lib/client/protobuf.js", "boot/deps/pomelo-protobuf/lib/client/protobuf.js");
myrequire.alias("pomelonode-pomelo-protobuf/lib/client/protobuf.js", "boot/deps/pomelo-protobuf/index.js");
myrequire.alias("pomelonode-pomelo-protobuf/lib/client/protobuf.js", "pomelonode-pomelo-protobuf/index.js");

myrequire.alias("pomelonode-pomelo-jsclient-websocket/lib/pomelo-client.js", "boot/deps/pomelo-jsclient-websocket/lib/pomelo-client.js");
myrequire.alias("pomelonode-pomelo-jsclient-websocket/lib/pomelo-client.js", "boot/deps/pomelo-jsclient-websocket/index.js");
myrequire.alias("pomelonode-pomelo-jsclient-websocket/lib/pomelo-client.js", "pomelonode-pomelo-jsclient-websocket/index.js");

myrequire("boot")
}

module.exports = LoadPomelo;